...
public class MetabolicRxns {
  ...
  public MetabolicRxns(List<String> reactants, String id, String source, List<String> ecs,
      List<String> products, List<String> cpds, String pathway) {
    super();
    this.reactants = reactants;
    this.id = id;
    this.source = source;
  ...
  public String toString() {
    return "MetabolicRxns [reactants=" + reactants + ", id=" + id + ", source=" + source + ", ecs="
        + ecs + ", products=" + products + ", cpds=" + cpds + ", pathway=" + pathway + "]";
  }
