...
public class Constants {
  ...
  public static List<String> currList = new ArrayList<String>(
      Arrays.asList("C00001", "C00080", "C00007", "C00006", "C00005", "C0000", "C00004", "C00002",
          "C00013", "C00008", "C00009", "C00011", "G11113", "H2O", "H+", "Oxygen", "NADP+", "NADPH",
          "NAD+", "NADH", "ATP", "Pyrophosphate", "ADP", "Orthophosphate", "CO2"));


  public static List<String> shapesList =
      new ArrayList<String>(Arrays.asList("diamond", "octagon", "invtrapezium", "triangle", "box",
          "trapezium", "invtriangle", "parallelogram", "polygon", "egg"));

  public static List<String> zcolors =
      new ArrayList<String>(Arrays.asList("#99BBFF", "#99CCFF", "#99DDFF", "#99EEFF", "#99FFFF",
          "#FFFFFF", "#FFEE44", "#FFCC44", "#FFBB44", "#FFAA44", "#FF9944"));
  ...
  public static List<String> primary_ions = new ArrayList<String>(
      Arrays.asList("M+H[1+]", "M+Na[1+]", "M-H2O+H[1+]", "M-H[-]", "M-2H[2-]", "M-H2O-H[-]"));


  public static final Map<String, List<String>> wanted_adduct_list;
  static {
    wanted_adduct_list = new HashMap<String, List<String>>();
    List<String> pos_default = new ArrayList<String>(Arrays.asList("M[1+]", "M+H[1+]", "M+2H[2+]",
        "M(C13)+H[1+]", "M(C13)+2H[2+]", "M+Na[1+]", "M+H+Na[2+]", "M+HCOONa[1+]"));
    List<String> dpj_positive = new ArrayList<String>(Arrays.asList("M[1+]", "M+H[1+]", "M+2H[2+]",
        "M(C13)+H[1+]", "M(C13)+2H[2+]", "M+Na[1+]", "M+H+Na[2+]", "M+HCOONa[1+]", "M(Cl37)+H[1+]",
        "M(S34)+H[1+]", "M+K[1+]", "M+HCOOK[1+]"));
    List<String> generic_positive = new ArrayList<String>(Arrays.asList("M[1+]", "M+H[1+]",
        "M+2H[2+]", "M+3H[3+]", "M(C13)+H[1+]", "M(C13)+2H[2+]", "M(C13)+3H[3+]", "M(S34)+H[1+]",
        "M(Cl37)+H[1+]", "M+Na[1+]", "M+H+Na[2+]", "M+K[1+]", "M+H2O+H[1+]", "M-H2O+H[1+]",
        "M-H4O2+H[1+]", "M-NH3+H[1+]", "M-CO+H[1+]", "M-CO2+H[1+]", "M-HCOOH+H[1+]", "M+HCOONa[1+]",
        "M-HCOONa+H[1+]", "M+NaCl[1+]", "M-C3H4O2+H[1+]", "M+HCOOK[1+]", "M-HCOOK+H[1+]"));
    List<String> negative = new ArrayList<String>(Arrays.asList("M-H[-]", "M-2H[2-]", "M(C13)-H[-]",
        "M(S34)-H[-]", "M(Cl37)-H[-]", "M+Na-2H[-]", "M+K-2H[-]", "M-H2O-H[-]", "M+Cl[-]",
        "M+Cl37[-]", "M+Br[-]", "M+Br81[-]", "M+ACN-H[-]", "M+HCOO[-]", "M+CH3COO[-]", "M-H+O[-]"));
